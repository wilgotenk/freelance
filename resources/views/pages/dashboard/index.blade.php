                            ...
                            <tr class="text-gray-700">
                                <td class="w-1/2 px-1 py-2">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-medium text-black">Client 1</p>
                                            <p class="text-sm text-gray-400">31 May 2024</p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="text-gray-700">
                                <td class="w-1/2 px-1 py-2">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-medium text-black">Client 2</p>
                                            <p class="text-sm text-gray-400">31 May 2024</p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="text-gray-700">
                                <td class="w-1/2 px-1 py-2">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-medium text-black">Client 3</p>
                                            <p class="text-sm text-gray-400">31 May 2024</p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="text-gray-700">
                                <td class="w-1/2 px-1 py-2">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-medium text-black">Client 4</p>
                                            <p class="text-sm text-gray-400">31 May 2024</p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="text-gray-700">
                                <td class="w-1/2 px-1 py-2">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-medium text-black">Client 5</p>
                                            <p class="text-sm text-gray-400">31 May 2024</p>
                                        </div>
                                    </div>
                                </td>
